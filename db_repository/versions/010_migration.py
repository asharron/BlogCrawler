...
def upgrade(migrate_engine):
    ...
    post_meta.tables['mentee'].columns['bio'].create()
    post_meta.tables['mentor'].columns['bio'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['mentee'].columns['bio'].drop()
    post_meta.tables['mentor'].columns['bio'].drop()
