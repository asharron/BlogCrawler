...
def upgrade(migrate_engine):
    ...
    post_meta.tables['user'].columns['fname'].create()
    post_meta.tables['user'].columns['interest'].create()
    post_meta.tables['user'].columns['lname'].create()
...
def downgrade(migrate_engine):
    ...
    post_meta.tables['user'].columns['fname'].drop()
    post_meta.tables['user'].columns['interest'].drop()
    post_meta.tables['user'].columns['lname'].drop()
